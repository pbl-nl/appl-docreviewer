...
def create_vectordb_path(content_folder_path: str,
                         ...
                         text_splitter_method: str | None = None,
                         chunk_size: int | None = None,
                         chunk_overlap: int | None = None,
                         text_splitter_method_child: str | None = None,
                         chunk_size_child: int | None = None,
                         chunk_overlap_child: int | None = None) -> str:
    """
...
def is_relevant_file(content_folder_path: str, document_selection: List[str] | None, my_file: str) -> bool:
    """
...
def get_relevant_files_in_folder(content_folder_path: str,
                                 document_selection: List[str] | None = None) -> List[str]:
    """
